...
def label_propagation(graph, max_iterations=10):
    ...
    for iteration in range(max_iterations):
        ...
        # Print the labels and the number of unique labels after each iteration
        print(f"Iteration {iteration+1}: Labels - {labels}, Unique Labels - {unique_labels}")
...
final_labels = label_propagation(graph, max_iterations=100)
